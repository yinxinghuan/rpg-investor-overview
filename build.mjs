...
import './design/render-art-diagram.mjs';
...
await writeFile(new URL('./dist/release.json', import.meta.url), JSON.stringify({commit, versions: ['A', 'C'], languages: ['zh', 'en'], feature: 'rules-memory-multiplayer-bilingual-v1'}, null, 2));
